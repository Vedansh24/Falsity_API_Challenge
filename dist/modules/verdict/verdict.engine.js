...
function computeFinalVerdict(input) {
...
function buildReasoning(evidences, context) {
    ...
    // PART 1: Summary
    const summary = `The system analyzed ${total} piece${total > 1 ? 's' : ''} of evidence, including ${supports} supporting and ${contradicts} contradicting source${supports + contradicts !== 1 ? 's' : ''}.`;
 ...
 */
function computeVerdict(evidences) {
